...
clear
echo -e "\033[1;31m"
echo "  __  __       _ _ _    _   _          _      __  __ _  "  
echo "-- |  \/  | __ _| (_) | _| | | |______ _(_)_ __|  \/  | | __"
echo "-- | |\/| |/ _` | | | |/ / | | |_  / _` | | '__| |\/| | |/ /"
echo "-- | |  | | (_| | | |   <| |_| |/ / (_| | | |  | |  | |   < "
echo "-- |_|  |_|\__,_|_|_|_|\_\\___//___\__,_|_|_|  |_|  |_|_|\_\"
echo -e "\033[0m"
echo -e "\033[1;33m> Developer: Malik Uzair Mk \033[0m"
...
echo "Channel Link:"
echo "https://chat.whatsapp.com/E3bclUwBNuD1c3JyOPS08F"
echo -e "\033[0m"
echo -e "\033[1;34m----------------------------------------\033[0m"
